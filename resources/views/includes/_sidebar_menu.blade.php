<div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;">
        <a href="{{url('/home')}}" class="site_title"><i class="fa fa-plane"></i> <span>BawanaERP!</span></a>
    </div>
    ...
    <div class="profile">
        <div class="profile_pic">
            <img src="{{url('assets/images/users/'.Auth::user()->foto)}}" alt="..." class="img-circle profile_img">
        </div>
